...
int main(int argc, char **argv)
{
    ...
    FRP_SLAM::System SLAM(argv[1],argv[2],FRP_SLAM::System::IMU_STEREO, true, 0, file_name);
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            if(ni>0)
            {
                ...
                {
                    // vImuMeas.push_back(FRP_SLAM::IMU::Point(vAcc[first_imu],vGyro[first_imu],vTimestampsImu[first_imu]));
                    vImuMeas.push_back(FRP_SLAM::IMU::Point(vAcc[seq][first_imu[seq]].x,vAcc[seq][first_imu[seq]].y,vAcc[seq][first_imu[seq]].z,
