...
{  
    ...
    FRP_SLAM::System SLAM(argv[1],argv[2],FRP_SLAM::System::STEREO, false);
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            SLAM.TrackStereo(imLeftRect,imRightRect,tframe, vector<FRP_SLAM::IMU::Point>(), vstrImageLeft[seq][ni]);
